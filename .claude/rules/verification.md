...
Do not tell the user work is complete until you have run both commands and confirmed zero failures. If something fails, fix it — regardless of whether your changes caused it. A green test suite is the deliverable, not just your diff.
